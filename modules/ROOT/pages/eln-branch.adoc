...
responsibility.  Do you create the branch, build it once, and then leave
the branch to rot.

*If you decide that you no longer need the ELN branch, you must tell the
ELN SIG before retiring the branch.* The ELN SIG will need to change
configurations so that ELN starts to use the rawhide branch again.
